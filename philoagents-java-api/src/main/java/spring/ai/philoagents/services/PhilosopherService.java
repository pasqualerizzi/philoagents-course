...
public class PhilosopherService {
    ...
    public ChatResponse getPhilosopherResponse(PhilosopherState state, ChatClient chatClient) throws Exception {
        ...
        return chatClient.prompt(new Prompt(promptMessages)).tools(retrievePhilosopherContext).call().chatResponse();
    }
...
/*         QuestionAnswerAdvisor questionAnswerAdvisor = QuestionAnswerAdvisor.builder(vectorStore)
      ...
      QueryTransformer transformer = CompressionQueryTransformer.builder()
        ...
        Message lastMessage = state.lastMessage().orElseThrow(() -> new IllegalArgumentException("No last message found"));
